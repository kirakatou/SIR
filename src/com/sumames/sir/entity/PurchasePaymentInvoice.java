 ...
 */
@Entity
@Table(name = "purchase_payment_invoice", catalog = "sir", schema = "")
@NamedQueries({
    @NamedQuery(name = "PurchasePaymentInvoice.findAll", query = "SELECT p FROM PurchasePaymentInvoice p")})
public class PurchasePaymentInvoice implements Serializable {
    ...
    public PurchasePaymentInvoice() {
    }

    public PurchasePaymentInvoice(Integer recordId) {
        this.recordId = recordId;
    }

    public PurchasePaymentInvoice(Integer recordId, int purchasePaymentRecordId, int purchaseInvoiceRecordId) {
        this.recordId = recordId;
        this.purchasePaymentRecordId = purchasePaymentRecordId;
    ...
    public int getPurchasePaymentRecordId() {
        return purchasePaymentRecordId;
    }

    public void setPurchasePaymentRecordId(int purchasePaymentRecordId) {
        this.purchasePaymentRecordId = purchasePaymentRecordId;
    }
    ...
    public Double getBankTransaction() {
        return bankTransaction;
    }

    public void setBankTransaction(Double bankTransaction) {
        this.bankTransaction = bankTransaction;
    }

    public Double getGiroTransaction() {
        return giroTransaction;
    }

    public void setGiroTransaction(Double giroTransaction) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof PurchasePaymentInvoice)) {
            return false;
        }
        PurchasePaymentInvoice other = (PurchasePaymentInvoice) object;
    ...
    public String toString() {
        return "com.sumames.sir.entity.PurchasePaymentInvoice[ recordId=" + recordId + " ]";
    }
